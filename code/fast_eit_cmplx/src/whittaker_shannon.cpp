...
void whittaker_shannon(VecComplex &q,MatDouble &x,MatDouble &xi,Array3Complex &qhat)
{
  ...
  q = (VecComplex)boostublas::prec_prod(qhatline,complexfunmat(MatOp(xix,[](double c) -> double { return cos(c); }),MatOp(xix,[](double c) -> double { return sin(c); })))/8.0;
}
