...
#pragma omp parallel for default(none) shared(diffdtn,x,wtrep,xi,kappa,k,kT,matpsizeta,qhat,n,ng,ng2,ng3,ximax,F0,alphac,ipiv,side,transn,m,lo,diagu,up,diagn)
