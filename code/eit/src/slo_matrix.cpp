...
/*
  ...
  Where wt is the weight at x_{kl}, it is given by wt=\pi/N wtl(theta_{kl}) where wtl are the weights given by the function gauss_legendre and where P_m are the Legendre polynomials.
*/
